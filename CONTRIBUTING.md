...
- **Extend the reference SDK.** A Python reference implementation of Layers 1, 2, and 6 — including streaming, heartbeats, and cancellation — lives at [github.com/a2agora/sdk-reference](https://github.com/a2agora/sdk-reference) ([Codeberg mirror](https://codeberg.org/a2agora/sdk-reference)). Additional transports (WebSocket/Streamable HTTP), streaming DAG edges, and a Layer 4 escrow-agent implementation are good entry points for a first PR.
